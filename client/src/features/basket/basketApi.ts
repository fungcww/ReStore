...
export const {useFetchBasketQuery, useAddBasketItemMutation, useRemoveBasketItemMutation} = basketApi;//this return api method just rename useFetchBasketQueryuseFetchBasketQuery
